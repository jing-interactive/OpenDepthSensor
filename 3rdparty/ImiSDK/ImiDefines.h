...
#define MAX_SN_SIZE 64
    ...
    typedef void(_stdcall* ImiDeviceStateCallback)(const char* deviceUri,
                                                   ImiDeviceState deviceState, void* pUserData);
#else
typedef void (*ImiNewFrameCallback)(ImiStreamHandle stream, void* pUserData);
typedef void (*ImiDeviceStateCallback)(const char* deviceUri, ImiDeviceState deviceState,
                                       void* pUserData);
#endif
