 ...
 int APIENTRY KCBOpenDefaultSensor()
{
 ...
 HRESULT APIENTRY KCBCloseSensor(_Inout_ int* pkcbHandle)
{
 ...
 HRESULT APIENTRY KCBGetAudioFrame(_In_ int kcbHandle, _Inout_ KCBAudioFrame* pstAudioFrame)
{
 ...
 HRESULT APIENTRY KCBGetAudioData(_In_ int kcbHandle, ULONG cAudioBufferSize, _Inout_cap_(cAudioBufferSize) byte* pbAudioBuffer, _Out_ ULONG* ulBytesRead, _Out_opt_ FLOAT* beamAngle, _Out_opt_ FLOAT* sourceConfidence)
{
    if (KCB_INVALID_HANDLE == kcbHandle)
    {
        return E_INVALIDARG;
 ...
 HRESULT APIENTRY KCBGetBodyFrame(_In_ int kcbHandle, _Inout_ KCBBodyFrame* pstBodyFrame)
{
 ...
 HRESULT APIENTRY KCBGetBodyIndexFrameBuffer(_In_ int kcbHandle, ULONG cbBufferSize, _Inout_cap_(cbBufferSize) BYTE* pbBuffer, _Out_opt_ LONGLONG* llTimeStamp)
{
    if (KCB_INVALID_HANDLE == kcbHandle)
    {
        return E_INVALIDARG;
...
#pragma region Event Functions
 bool APIENTRY KCBIsFrameReady(_In_ int kcbHandle, FrameSourceTypes eSource)
{
    if (KCB_INVALID_HANDLE == kcbHandle)
    {
        return false;
